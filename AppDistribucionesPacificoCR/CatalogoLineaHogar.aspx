<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CatalogoLineaHogar.aspx.cs" Inherits="AppDistribucionesPacificoCR.CatalogoLineaHogar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="card-title">Catálogo de línea hogar</h4>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <asp:SqlDataSource id="dataProductos" runat="server" ConnectionString='<%$ ConnectionStrings:ProyectoConnectionString %>' SelectCommand="SELECT codBarra, nombreProducto, descripcion, precioVenta, foto, exento FROM TblProducto WHERE (idClasificacion = 3) AND (estado='Disponible')"></asp:SqlDataSource>
