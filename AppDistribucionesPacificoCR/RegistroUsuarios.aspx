<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RegistroUsuarios.aspx.cs" Inherits="AppDistribucionesPacificoCR.RegistroUsuarios" %>
    ...
    <div class="container col-md-6 col-lg-6 col-xl-6 text-center div-radius loginContainer" >
        <div class="justify-content-center text-center">
            ...
            <div class="form-group mt-4">
                <div class="row">
                    <div class="col-md-12">
                        <asp:Label Text="Registro de usuarios" runat="server" style="color:white"/>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-2">
                        <asp:Label Text="Confirmar contraseña" runat="server" style="color:white"/>
                    </div>
                    <div class="col-md-8">
                        <asp:TextBox id="txtConfirmarContrasena" CssClass="form-control" MaxLenght="80" runat="server" />  
                    </div>
                    <div class="col-md-1"> 
                        <asp:RequiredFieldValidator id="requiredTxtConfirmarContrasena" ErrorMessage="La contraseña es un campo requerido" ControlToValidate="txtConfirmarContrasena" ForeColor="Red" runat="server">*</asp:RequiredFieldValidator>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group ">
                <div class="row">
                    <div class="col-md-12">
                        <asp:Button id="btnRegistrarCompra" CssClass="btn btn-light barraNavegacion" Text="Registrarse" runat="server" style="color:#000000" />
                    </div>
                </div>
            </div>
